...
- [yutotakano](https://github.com/discord-haskell/discord-haskell/pull/252) Fix a bug in the `interaction-commands` example and add more commentary to optionValue{Integer|Number}{Max|Min}Val fields
